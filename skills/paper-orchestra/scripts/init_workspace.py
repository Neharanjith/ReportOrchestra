...
README inside `inputs/` listing the required and optional input files.
...
INPUTS_README = textwrap.dedent("""\
    ...
    The paper-orchestra pipeline expects the four required files below in this
    directory before you start. Optional author guidance goes in
    `authors_note.md`; optional figures go in `figures/`.
    ...
    - `authors_note.md`          — Author preferences and global constraints for
                                   outlining, writing, and refinement. Venue rules and
                                   scientific integrity take precedence.
