...
def main() -> int:
    ...
    author_note = os.path.join(inputs, "authors_note.md")
    if os.path.isfile(author_note) and os.path.getsize(author_note) > 0:
        print("INFO: authors_note.md present — outline agent will apply author guidance")
    elif os.path.isfile(author_note):
        print("INFO: authors_note.md is empty — continuing without author guidance")
    else:
        print("INFO: no authors_note.md — continuing without author guidance")
